      ...
      <div class="empty-inbox">
        <div class="loading-animation">
          <svg class="loading-arrows" viewBox="0 0 100 100">
            <path d="M25 25 A35 35 0 0 1 75 25" fill="none" stroke="#c0c0c0" stroke-width="3" stroke-linecap="round"/>
            <polygon points="75,20 82,28 72,30" fill="#c0c0c0"/>
            <path d="M75 75 A35 35 0 0 1 25 75" fill="none" stroke="#c0c0c0" stroke-width="3" stroke-linecap="round"/>
            <polygon points="25,80 18,72 28,70" fill="#c0c0c0"/>
          </svg>
